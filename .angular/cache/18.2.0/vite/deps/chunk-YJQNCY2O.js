...
import {
  ...
  isFunction,
  noop
} from "./chunk-DUKZ7MUC.js";
import {
  __spreadProps,
  __spreadValues
} from "./chunk-NEYRJIQJ.js";
...
var NON_BUBBLING_MOUSE_EVENTS = [EventType.MOUSEENTER, EventType.MOUSELEAVE, "pointerenter", "pointerleave"];
...
var CAPTURE_EVENTS = [EventType.FOCUS, EventType.BLUR, EventType.ERROR, EventType.LOAD, EventType.TOGGLE];
...
function serializeI18nBlock(lView, caseQueue, context, node) {
  switch (node.kind) {
    ...
    case 1:
    case 2:
      node.children.forEach((node2) => serializeI18nBlock(lView, caseQueue, context, node2));
      break;
    case 3:
      ...
      if (currentCase != null) {
        ...
        node.cases[caseIdx].forEach((node2) => serializeI18nBlock(lView, caseQueue, context, node2));
      }
      break;
  }
}
...
@angular/core/fesm2022/core.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-YJQNCY2O.js.map
